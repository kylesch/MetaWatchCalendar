...
public class MetaWatchCALENDARActivity extends Activity {
    /** Called when the activity is first created. */
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.main);
		startService(new Intent(this, MetaWatchCALENDARService.class));
    }
    ...
    public void test(View view) {
		...
		/* OLED display */
		req.oledTopText = "CAL";
		req.oledBottomLine1Text = MetaWatchCALENDARService.title;
		req.oledBottomLine2Text = "Meeting Located at " + MetaWatchCALENDARService.location + " starts in " + MetaWatchCALENDARService.begin + " minutes";

		/* LCD display */
		req.lcdText = MetaWatchCALENDARService.title +"\nMeeting Located at " + MetaWatchCALENDARService.location + " starts in " + MetaWatchCALENDARService.begin + " minutes";
